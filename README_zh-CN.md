...
| 路径 | 用途 |
| --- | --- |
| `BLE-SPI-Rx/` | Nordic/Zephyr BLE 接收端，通过 SPI 转发图像数据 |
| `915TX/` | TI CC1310 SPI 到 915 MHz 的发送端固件 |
| `915RX/` | TI CC1310 915 MHz 到 SPI 的接收端固件 |
| `jetson_spi_slave_jpeg_rx_simple.c` | Linux/Jetson SPI 接收与 JPEG 重组程序 |
| `wifi_TCP-main/` | Nordic nRF7002 Wi-Fi/BLE 图像传输实验及主机接收工具 |
