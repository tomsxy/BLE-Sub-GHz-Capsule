...
enum its_rx_cmd_e {
	...
	ITS_RX_CMD_TXP, 
	ITS_RX_CMD_WIFIONOFF,
	ITS_RX_CMD_WIFIACTIVE,
	ITS_RX_CMD_THROUGHPUT_NOTIFY,
	ITS_RX_CMD_BORDER_NOTIFY
...
int bt_its_send_img_data(struct bt_conn *conn, const uint8_t *buf, uint16_t length, uint16_t le_max_length);
